...
var options2 = {
    ...
    colors: ['#7266ba', '#1abc9c', "#f1556c", "#6c757d"],
    xaxis: {
        tickAmount: 12,
        type: 'datetime',
...
var options = {
    ...
    colors: ['#1abc9c', "#f1556c", "#6c757d", "#7266ba", "#6559cc"],
    grid: {
        borderColor: '#f1f3fa',
        xaxis: {
            showLines: true
...
var options = {
    ...
    colors: ["#7266ba", "#f672a7", "#6c757d", "#37cde6","#d1dee4"],
    legend: {
        show: true,
        position: 'bottom',
...
var options = {
    ...
    colors: ["#7266ba", "#f672a7", "#6c757d", "#37cde6"],
    series: [44, 55, 67, 83],
