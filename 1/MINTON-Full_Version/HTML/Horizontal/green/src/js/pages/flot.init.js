...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var colors = ["#1abc9c", "#3bafda", "#6c757d", "#f7b84b","#d1dee4"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#1abc9c']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ["#1abc9c", "#3bafda", "#6c757d", "#f7b84b","#d1dee4"];
