        ...
        ChartJs.prototype.initCharts = function () {
            ...
            if ($('#line-chart-example').length > 0) {
                var lineChart = {
                    ...
                    datasets: [{
                        label: "Current Week",
                        backgroundColor: 'rgba(240, 107, 120, 0.3)',
                        borderColor: '#f06b78',
                    ...
                    datasets: [
                        {
                            ...
                            backgroundColor: "#f06b78",
                            borderColor: "#f06b78",
                            hoverBackgroundColor: "#f06b78",
                            hoverBorderColor: "#f06b78",
            ...
            if ($('#radar-chart-example').length > 0) {
                ...
                var radarChart = {
                    ...
                    datasets: [
                        {
                            label: "Desktops",
                            backgroundColor: "rgba(240, 107, 120,0.2)",
                            borderColor: "#f06b78",
                            pointBackgroundColor: "#f06b78",
                            pointBorderColor: "#fff",
                            pointHoverBackgroundColor: "#fff",
                            pointHoverBorderColor: "#f06b78",
                            data: [65, 59, 90, 81, 56, 55, 40]
                        },
                        {
                            label: "Tablets",
                            backgroundColor: "rgba(227, 234, 239,0.2)",
                            borderColor: "#e3eaef",
                            pointBackgroundColor: "#e3eaef",
                            pointBorderColor: "#fff",
                            pointHoverBackgroundColor: "#fff",
                            pointHoverBorderColor: "#e3eaef",
