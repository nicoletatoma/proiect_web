...
var options2 = {
    ...
    colors: ['#3b73da', '#2bc3a5', '#f7b84b', "#6c757d"],
    xaxis: {
        tickAmount: 12,
        type: 'datetime',
...
var options = {
    ...
    colors: ['#2bc3a5', "#f1556c", "#6c757d", "#37cde6", "#6559cc"],
    grid: {
        borderColor: '#f1f3fa',
        xaxis: {
            showLines: true
...
var options = {
    ...
    colors: ['#3b73da', '#2bc3a5', '#f7b84b', "#f672a7","#d1dee4"],
    legend: {
        show: true,
        position: 'bottom',
...
var options = {
    ...
    colors: ['#3b73da', '#2bc3a5', '#f7b84b',"#f64f69"],
    series: [44, 55, 67, 83],
