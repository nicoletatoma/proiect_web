...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b', 'c'], ["Bitcoin", "Ethereum", "Litecoin"], ['#1abc9c', '#3bafda','#697989']);
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b'], ["Bitcoin", "Ethereum"],['1'], ['#3bafda','#697989']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ["Bitcoin", "Ethereum", "Litecoin"], ['#1abc9c', '#3bafda', '#697989']);
        ...
        this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b'], ["Bitcoin","Litecoin"],['#ffffff'],['#999999'], ['#697989', '#3bafda']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#1abc9c', '#3bafda', '#697989']);
    },
    //init
