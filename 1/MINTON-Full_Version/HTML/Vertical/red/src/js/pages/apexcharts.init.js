...
var options2 = {
    ...
    colors: ['#6c757d', '#f06b78', "#f1556c", "#6c757d"],
    xaxis: {
        tickAmount: 12,
        type: 'datetime',
...
var options = {
    ...
    colors: ["#f06b78", "#6c757d", "#6c757d", "#f7b84b","#d1dee4"],
    grid: {
        borderColor: '#f1f3fa',
        xaxis: {
            showLines: true
...
var options = {
    ...
    colors: ["#f06b78", "#6c757d", "#3bafda", "#f7b84b","#d1dee4"],
    legend: {
        show: true,
        position: 'bottom',
...
var options = {
    ...
    colors: ["#f06b78", "#6c757d", "#3bafda", "#f7b84b"],
    series: [44, 55, 67, 83],
