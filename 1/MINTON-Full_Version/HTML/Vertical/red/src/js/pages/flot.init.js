...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var colors = ["#6c757d", "#f06b78", "#3bafda", "#f7b84b","#d1dee4"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#6c757d']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ["#6c757d", "#f06b78", "#3bafda", "#f7b84b","#d1dee4"];
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#e3eaef','#f06b78','#6c757d'], ds);
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ['#f06b78','#6c757d'], line_data);
	},
