...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b', 'c'], ["Bitcoin", "Ethereum", "Litecoin"], ['#009688', '#3f51b5','#e3eaef']);
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b'], ["Bitcoin", "Ethereum"],['1'], ['#3f51b5','#e3eaef']);
        ...
        this.createLineChart('morris-line-example', $data, 'y', ['a', 'b'], ["Bitcoin", "Ethereum"],['0.1'],['#ffffff'],['#999999'], ['#009688', '#3f51b5']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ["Bitcoin", "Ethereum", "Litecoin"], ['#009688', '#3f51b5', '#ebeff2']);
        ...
        this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b'], ["Bitcoin","Litecoin"],['#ffffff'],['#999999'], ['#e3eaef', '#3f51b5']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#009688', '#3f51b5', '#ebeff2']);
    },
    //init
