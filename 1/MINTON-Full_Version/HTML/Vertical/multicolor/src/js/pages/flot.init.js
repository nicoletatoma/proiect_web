...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var colors = ['#3b73da', '#2bc3a5', '#f7b84b', "#f672a7","#d1dee4"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#3b73da']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ['#3b73da', '#2bc3a5', '#f7b84b', "#f672a7","#d1dee4"];
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#e3eaef','#3bafda','#f64f69'], ds);
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ['#3bafda','#f64f69'], line_data);
	},
